...
public class BookController{
	...
	public Book create (@RequestBody Book book) throws Exception 
	{
	   ...
	   try {
			 value= bookService.create(book);
			   logger.info("sending book to service");
	...
	@GetMapping
	public List<Book> getAllBook(@RequestParam(defaultValue="0")Integer pageNo,@RequestParam(defaultValue="10")Integer pageSize,@RequestParam(defaultValue="id")String sortBy)
	{
